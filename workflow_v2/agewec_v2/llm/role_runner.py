...
LANGUAGE_POLICY = (
    "LANGUAGE POLICY — read all three rules before writing anything.\n"
    "\n"
    "RULE A (highest priority). These fields MUST be written in English, "
    "never in Japanese: " + ", ".join(ENGLISH_PROMPT_FIELDS) + ".\n"
    "  They are not descriptions for a human reader. They are sent verbatim "
    "  to a video generation model (Runway / Veo / Seedance) that was trained "
    "  on English captions. Japanese text in these fields degrades the "
    "  generated footage. This rule overrides Rule B.\n"
    "  Correct:   \"Golden hour over the city, slow pan to the right, "
    "cinematic, photorealistic\"\n"
    "  Incorrect: \"夕暮れの街並み、ゆっくりと右へパン\"\n"
    "\n"
    "RULE B. Every other human-readable field is written in Japanese "
    "(日本語): titles, loglines, scenes, narration, reasons, rationales, "
    "camera_motion, constraints, success criteria, issues, recommendations, "
    "and any other explanatory text. A human approves these on screen.\n"
    "\n"
    "RULE C. These fields are machine tokens. Return them exactly as given by "
    "the schema and upstream context — never translate or localise them: "
    + ", ".join(MACHINE_TOKEN_FIELDS) + ", plus every value constrained by "
