...
実行:
  cd ~/Downloads/Agewec
  uv run python -m agewec_v2.test_comfy_1cut             # 既定: 8秒・draftプロファイル
  uv run python -m agewec_v2.test_comfy_1cut --seconds 8 --profile final
  uv run python -m agewec_v2.test_comfy_1cut --image assets_dl/asset-001_夜景_皿倉_....jpg
...
from .paths import CONFIG_ROOT, WORKFLOW_ROOT
