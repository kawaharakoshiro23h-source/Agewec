...
from agewec_v2.paths import CONFIG_ROOT, PACKAGE_ROOT, RuntimePaths
...
class RuntimePathsTest(unittest.TestCase):
    def test_canonical_source_and_config_roots_exist(self) -> None:
        self.assertEqual(PACKAGE_ROOT.parent.name, "src")
        self.assertTrue((PACKAGE_ROOT / "prompts").is_dir())
        self.assertTrue((CONFIG_ROOT / "config_local.yaml").is_file())
        self.assertTrue((CONFIG_ROOT / "config_llm.yaml").is_file())
